...
import MyProposals from "./pages/professional/MyProposals";
...
import UserAttendees from "./pages/dashboard/UserAttendees";
import UserMessaging from "./pages/dashboard/UserMessaging";
import UserAnalytics from "./pages/dashboard/UserAnalytics";
import UserSettings from "./pages/dashboard/UserSettings";
import UserRSVPs from "./pages/dashboard/UserRSVPs";
      ...
      <BrowserRouter>
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route path="/professional/events/:id" element={<EventDetail />} />
            <Route path="/professional/my-tickets" element={<MyTickets />} />
            <Route path="/professional/my-proposals" element={<ProtectedRoute requiredRole="USER"><MyProposals /></ProtectedRoute>} />
            ...
            <Route path="/social/e/:id" element={<SocialEventPage />} />
            ...
            <Route path="/admin" element={<ProtectedRoute requiredRole="CONTENT_MANAGER"><AdminLayout /></ProtectedRoute>}>
              ...
              <Route path="proposals" element={<AdminPromotionRequests />} />
            ...
            <Route path="/dashboard" element={<ProtectedRoute requiredRole="USER"><UserDashboardLayout /></ProtectedRoute>}>
              <Route index element={<UserOverview />} />
              <Route path="events" element={<UserEvents />} />
              <Route path="attendees" element={<UserAttendees />} />
              <Route path="rsvps" element={<UserRSVPs />} />
              <Route path="proposals" element={<MyProposals />} />
              <Route path="messaging" element={<UserMessaging />} />
